...
**c.** Now change the render method to render a table or a ul with all the data fetched from the backend.
...
Set up the initial state in the class like this: ` {names:[],sizePerPage: 10, page:1, totalSize: 0 }`
